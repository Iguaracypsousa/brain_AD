---
title: "Tutorial 6. TF activity analysis using ATAC-seq dataset"
...
```{r}
scATAC_brain <- readRDS("../data/scATAC_brain_ACTIVITY_norm.rds")
...
write.csv(nonAD_TFs, "../results/TF_activity/scATAC_brain_nonAD.csv")
write.csv(earlyAD_TFs, "../results/TF_activity/scATAC_brain_earlyAD.csv")
write.csv(lateAD_TFs, "../results/TF_activity/scATAC_brain_lateAD.csv")
